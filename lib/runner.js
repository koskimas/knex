...
(0, _assign3.default)(Runner.prototype, {
  ...
  ensureConnection: function ensureConnection() {
    ...
    if (this.connection) {
      connectionPromise = _bluebird2.default.resolve(this.connection);
    } else {
      connectionPromise = this.client.acquireConnection().completed;
    }

    return connectionPromise.catch(_tarn.TimeoutError, function (error) {
      ...
      if (_this2.builder) {
        additionalErrorInformation.sql = _this2.builder.sql;
        additionalErrorInformation.bindings = _this2.builder.bindings;
      }

      (0, _assign3.default)(timeoutError, additionalErrorInformation);

      return _bluebird2.default.reject(timeoutError);
    }).disposer(function () {
